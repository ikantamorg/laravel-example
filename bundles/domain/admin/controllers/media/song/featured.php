...
class Admin_Media_Song_Featured_Controller extends Rest_Controller
{
	public $restful = true;
	...
	public $view_base = 'admin::media.songs.featured.';
	public $base_uri = 'admin/media/song/featured/';
	...
	public function listing()
	{
		...
		return $this->_listing = $featured_ids ? 
								  Song::where_in('id', $featured_ids)->get()
								: [];
	}
