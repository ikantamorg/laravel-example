...
class Admin_Event_Recommended_Controller extends Rest_Controller
{
	public $resource_type = 'events';

	public $fields = ['type', 'resource_id'];
	public $view_base = 'admin::events.recommended.';
	public $base_uri = 'admin/event/recommended/';
	...
	public function listing()
	{
		...
		return $this->_listing = $recommended_ids ? 
								  Event::where_in('id', $recommended_ids)->get()
								: [];
	}
	...
	protected function form()
	{
		$form = Hybrid\Form::make(function ($f) {
			...
			$f->fieldset('Recommended Events', function ($fs) {
