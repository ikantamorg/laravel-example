...
class Admin_Artist_Recommended_Controller extends Rest_Controller
{
	public $resource_type = 'artists';

	public $fields = ['type', 'resource_id'];
	public $view_base = 'admin::artists.recommended.';
	public $base_uri = 'admin/artist/recommended/';
	...
	public function listing()
	{
		...
		return $this->_listing = $recommended_ids ? 
								  Artist::where_in('id', $recommended_ids)->get()
								: [];
	}
	...
	protected function form()
	{
		$form = Hybrid\Form::make(function ($f) {
			...
			$f->fieldset('Recommended Artists', function ($fs) {
